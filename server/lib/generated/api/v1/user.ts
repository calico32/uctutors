...
export const User = {
  encode(message: User, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.pictureUrl !== '') {
      writer.uint32(146).string(message.pictureUrl)
    }
  ...
  toJSON(message: User): unknown {
    ...
    if (message.virtualAvailability?.length) {
      obj.virtualAvailability = message.virtualAvailability.map((e) =>
        VirtualAvailability.toJSON(e)
      )
    }
  ...
  fromPartial(object: DeepPartial<User>): User {
    ...
    message.campusAvailability =
      object.campusAvailability?.map((e) => CampusAvailability.fromPartial(e)) || []
    message.virtualAvailability =
      object.virtualAvailability?.map((e) => VirtualAvailability.fromPartial(e)) || []
...
export interface UserServiceImplementation<CallContextExt = {}> {
  ...
  ): Promise<DeepPartial<GetUserResponse>>
}
